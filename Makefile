...
U_SRCS = init.c idle.c pid.c brk.c delay.c fork.c exec.c wait.c write_read.c bigstack.c forktest.c torture.c zero.c traps.c shell.c pipes.c locks.c locks1.c cvars.c
